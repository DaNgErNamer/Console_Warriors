...
internal class Actions
{
    ...
    //}
    #endregion
    static float Calculate_DamageThroughtArmor(Unit defender, float Damage, string attack_type) // —тарый скрипт рассчета урона через броню
    {
    ...
    static float Calculate_ArmorDestruction(Unit defender, float Damage, string attack_type) // —тарый скрипт рассчета урона по броне
    {
        float Armor = 0;
    ...
    static float Calcultate_ShieldDamage(float damage, Unit defender) // –ассчет урона по щиту
    {
